				...
				<div id="sidebar" class="grid_3">
					<div id="sidebar-header">
						<span id="sidebar-label" class="uppercased">
							<?php print __("We offer");?>
						</span>
					</div>
					
					<div id="sidebar-menu">
						<ul>
							<li class="bordered"><a href="<?php print _webBase . _sh . _webLang . _sh . "pages" . _sh . slug(__("Lodge")); ?>">* <?php print __("Cabin Rental");?></a></li>
					...
					<div id="sub-sidebar">
						<p> 
							<?php print __("Ask");?><br />
							<?php print __("For Our");?><br /> 
							<span class="bold"><?php print __("Promotions");?></span>
						</p>
					</div>
